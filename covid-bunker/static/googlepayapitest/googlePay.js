...
function getGoogleTransactionInfo() {
    let total_price = getCookie('purchaseCost');
  return {
    displayItems: [
      {
        label: "Subtotal",
...
function processPayment(paymentData) {
  return new Promise(function(resolve, reject) {
    setTimeout(function() {
      ...
      let address = paymentData.shippingAddress.name + ", " + paymentData.shippingAddress.address1
        + ", " + paymentData.shippingAddress.locality + " " + paymentData.shippingAddress.administrativeArea
        + " " + paymentData.shippingAddress.postalCode;
      //console.log(address);
      // @todo pass payment token to your gateway to process payment
      paymentToken = paymentData.paymentMethodData.tokenizationData.token;

      redirectPost('/checkout/', { shipping_address: address });
